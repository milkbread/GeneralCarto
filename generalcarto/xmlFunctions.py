...
def exemplaryWPSxmlCreation():
    #initialize the main object     --> needs the identifier of the function
        ...
        xmlMaker = xmlFunc.makeWPSxml(identifier, "/home/ralf/Software/Quickly/generalcarto/data/media/testWPSFile.xml")
        #send the input paramater to the object     --> meaning the generalization parameters
...
def makeGML(file):
    ...
    file2 = open('/home/klammer/Software/Quickly/generalcarto/data/media/template_ogr_output.gml', 'w')
